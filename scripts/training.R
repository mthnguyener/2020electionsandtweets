...
# Training Set
# Biden
hashbiden <- searchTwitter('#biden2020', n=1000, since='2020-10-27', until='2020-10-28')
hashbidenharris <- searchTwitter('#BidenHarris2020', n=1000, since='2020-10-27', until='2020-10-28')
...
# Trump
hashtrumppence <- searchTwitter('#TrumpPence2020', n=1000, since='2020-10-27', until='2020-10-28')
hashtrump <- searchTwitter('#trump2020', n=1000, since='2020-10-27', until='2020-10-28')
...
#Save to CSV
write.csv(raw.tidy, file = "10262020training.csv", row.names = FALSE)
...
write.csv(raw.set, file = "raw_set.csv", row.names = FALSE)
